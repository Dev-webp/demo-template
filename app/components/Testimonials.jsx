    ...
    <section className="py-20">
        <div className="max-w-7xl mx-auto px-5 sm:px-10 md:px-12 lg:px-5 space-y-16">
            <div className="max-w-2xl">
                <h1 className="font-bold text-gray-800 dark:text-white text-3xl uppercase">Client’s Say About Us</h1>
            </div>
            <div className="relative grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="p-5 md:p-6 space-y-6 rounded-lg bg-white dark:bg-gray-950 border border-gray-100 dark:border-gray-900 shadow-2xl shadow-gray-100/70 dark:shadow-gray-800/80">
                    <p className="font-medium text-gray-700 dark:text-gray-300 text-justify">
                    ...
                    <div className="flex items-start gap-4">
                        <Image src="/sidebiew.webp" width={1900} height={1200} alt="Author avatar" className="w-12 h-12 rounded-full flex object-cover" />
