...
const comp1 = () => {
  ...
  >
    ...
    <motion.div
      variants={containerVariants(0.4)}
      className="flex flex-col space-y-8 sm:space-y-10 lg:items-center text-center lg:text-left max-w-2xl md:max-w-4xl lg:max-w-5xl mx-auto mt-0 lg:mt-16 ml-0 lg:ml-16 relative z-10"
    >
      <motion.h1
      ...
      <motion.p
        ...
        className="flex text-gray-100 tracking-tight text-center md:font-medium max-w-xl mx-auto lg:max-w-none"
      >
    ...
    <motion.div
      ...
      initial="offscreen"
      animate="onscreen"
      className="flex aspect-square lg:aspect-auto h-[20rem] tablet:h-[30rem] lg:h-[35rem] relative mt-44 tablet:mt-10 md:mt-6 lg:mt-6 z-10 ml-0 md:ml-0 lg:ml-0 tablet:ml-20"
    >
      <motion.div
        variants={containerVariants(1)}
        className="absolute right-10 lg:right-10 bottom-0 lg:bottom-10  h-[calc(190%-100px)]  lg:h-[calc(80%-10px)] w-4/5 rounded-3xl overflow-hidden border-4 border-gray-200 z-30 p-6 bg-white shadow-2xl"
      >
